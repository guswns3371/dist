...
function mq($sql)
{
    ...
    return $db->query($sql);
        ...
        if(isset($_POST['getData'])){
            ...
            $sql00 = $conn->query("SELECT * FROM MusicInfo ORDER BY m_idx desc LIMIT $start,$limit");
            if($sql00->num_rows >0){
                $response = "";
        ...
        <div class="media-body" style="margin-left: 30px">
            ...
            <div class="btn pull-right"style="margin-left: 10px;padding-bottom: 3px;
                 ...
                 <label class="like_btn_area" id="like_btn_area">
                   ...
                   <label class="btn_playlist" style="margin-bottom: 20px;margin-right: 70px">
                     <div class="dropdown" >  
                      <button class="btn btn-outline-primary dropdown-toggle" data-toggle="dropdown" id="playlistbtn" style="padding-bottom: 3px;padding-top: 3px;margin-left: 10px; margin-bottom: 5px">Add</button>
