            ...
            <div class="col-12 col-lg-8" style="flex-grow: 0;flex-shrink: 0;flex-basis: 90%;max-width: 90%;">
                <div class="mt-100">
                    ...
                    <div id="upper-article-list"  class="single-articles-area d-flex flex-wrap mb-30">
                        <h1><?php
                            if($catagory == "comm_title"){
                                $a ="제목";
                            }
                            if($catagory == "comm_username"){
                                $a  ="글쓴이";
                            }
                            if($catagory == "comm_content"){
                                $a  ="내용";
                            }
                            echo $a ; ?>에서 '<?php echo $search_con; ?>' 검색결과</h1>
                        <div><h2 style="margin-top:10px;"><a class="btn pull-right" href="community_page.php?page=1" style="font-size: 28px">HOME</a></h2></div>
                    ...
                    <div id="lower-article-list" class="single-articles-area d-flex flex-wrap mb-30">
                        <table style="height: 50px;width: 1000px;">
                            ...
                            $sql1 = mq("select * from Community_Info where $catagory like '%$search_con%'");
//                            $sql = mq("select * from Community_Info");
                            ...
                            //$conn = mysqli_connect('localhost','root','wnsgusgk3537','user');
                            //                            $sql2 = "SELECT * FROM Community_Info";
                            $sql2 = mq("select * from Community_Info where $catagory like '%$search_con%' order by comm_num desc limit $start_num, $list");
                           ...
                           <tbody>
                            <tr>
                                ...
                                <td colspan=\"2\" class=\"td_article\">
                                    ...
                                    <div class=\"board-list\" style=\"width: 90px\">
                                        <div class=\"inner_list\" style=\"width: 600px\">
                                            ...
                                            <a class=\"article\" href=\" http://127.0.0.1/my/community_inner.php?comm_num=$comm_num&page=$page\">
                                               $comm_title
                                            </a>
                                ...
                                <td class=\"td_name\">
                                    ...
                                    <a href=\"#\" class=\"m-tcol-c\">$comm_username</a>
