...
$m_uploader =$_GET['liked_m_userid'];
...
<div class="" id="background_img" style="width: 1700px;margin:0 auto;">
    ...
    <div class="media-body" >
        ...
        <label>
            ...
            ?>
            <h2 class="d-inline-flex p-2" style="background-color: #505759;color: white; margin-top: 0px;margin-left: 30px">Hear the tracks you've liked ❤</h2>
            <?php }else {?>
                <h2 class="d-inline-flex p-2" style="background-color: #505759;color: white; margin-top: 0px;margin-left: 30px">Hear the tracks <?php echo $m_uploader?>'s liked ❤</h2>
            <?php }?>
            <div></div>
...
//    $sql2 =mq("select * from MusicInfo where m_idx ='$liked_m_m_idx' order by m_idx desc");
//
//
...
//    ?>
<!---->
<!--    <div class="container" id="liked_list_content" style="margin-bottom: 20px">-->
<!--        <div class="media">-->
...
<script>
    ...
    function getData() {
        ...
        $.ajax({
            url: 'music_liked_list_infinite_scroll.php',
            method : 'POST',
            dataType: 'text',
            data:{
                getData : 1,
                start : start,
                limit: limit,
                m_uploader2 : "<?php echo $m_uploader?>"
            },
